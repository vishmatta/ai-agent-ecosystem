...
No open-source inference providers are catalogued in this category: each is a hosted, paid API service.

## Legacy / Decommissioned

- [Lambda](https://lambda.ai/inference)
  - Inference API [shut down September 25, 2025](https://deeptalk.lambda.ai/t/sunsetting-chat-sunsetting-inference/4744). Lambda still rents GPU instances
