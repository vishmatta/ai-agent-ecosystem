...
- [Gemini Enterprise Agent Platform](https://cloud.google.com/products/gemini-enterprise-agent-platform) (Google)
  ...
  - Agent framework: [Agent Development Kit](https://docs.cloud.google.com/gemini-enterprise-agent-platform/agents), in [[build/agent-frameworks/code-frameworks|Code Frameworks]]
  - Agent runtime: [Agent Runtime](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/runtime), in the [[run/agent-operations/landscape|Operations and Deployment Landscape]]
...
- [Oracle AI Agent Studio for Fusion Applications](https://www.oracle.com/applications/dawn-of-ai-enterprise-agent-workforce/)
  - Nothing from this platform is catalogued elsewhere on the site yet
